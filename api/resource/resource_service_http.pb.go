...
const OperationResourceCreateResource = "/partyaffairs.api.resource.Resource/CreateResource"
const OperationResourceCreateResourceClassify = "/partyaffairs.api.resource.Resource/CreateResourceClassify"
const OperationResourceDeleteResource = "/partyaffairs.api.resource.Resource/DeleteResource"
const OperationResourceDeleteResourceClassify = "/partyaffairs.api.resource.Resource/DeleteResourceClassify"
const OperationResourceGetResource = "/partyaffairs.api.resource.Resource/GetResource"
const OperationResourceListResource = "/partyaffairs.api.resource.Resource/ListResource"
const OperationResourceListResourceClassify = "/partyaffairs.api.resource.Resource/ListResourceClassify"
const OperationResourceUpdateResource = "/partyaffairs.api.resource.Resource/UpdateResource"
const OperationResourceUpdateResourceClassify = "/partyaffairs.api.resource.Resource/UpdateResourceClassify"
...
func RegisterResourceHTTPServer(s *http.Server, srv ResourceHTTPServer) {
	r := s.Route("/")
	r.GET("/partyaffairs/api/v1/resource/classifies", _Resource_ListResourceClassify0_HTTP_Handler(srv))
	...
	r.GET("/partyaffairs/api/v1/resource", _Resource_GetResource0_HTTP_Handler(srv))
	r.GET("/partyaffairs/api/v1/resources", _Resource_ListResource0_HTTP_Handler(srv))
