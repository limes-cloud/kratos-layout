...
const OperationChatDeleteChatRecord = "/partyaffairs.api.chat.Chat/DeleteChatRecord"
const OperationChatGetChatSetting = "/partyaffairs.api.chat.Chat/GetChatSetting"
const OperationChatListChatRecord = "/partyaffairs.api.chat.Chat/ListChatRecord"
...
func RegisterChatHTTPServer(s *http.Server, srv ChatHTTPServer) {
	r := s.Route("/")
	r.GET("/partyaffairs/api/v1/chat/setting", _Chat_GetChatSetting0_HTTP_Handler(srv))
	r.GET("/partyaffairs/api/v1/chat/records", _Chat_ListChatRecord0_HTTP_Handler(srv))
	r.DELETE("/partyaffairs/api/v1/chat/record", _Chat_DeleteChatRecord0_HTTP_Handler(srv))
}
...
func (c *ChatHTTPClientImpl) DeleteChatRecord(ctx context.Context, in *DeleteChatRecordRequest, opts ...http.CallOption) (*DeleteChatRecordReply, error) {
	...
	pattern := "/partyaffairs/api/v1/chat/record"
...
func (c *ChatHTTPClientImpl) GetChatSetting(ctx context.Context, in *GetChatSettingRequest, opts ...http.CallOption) (*GetChatSettingReply, error) {
	...
	pattern := "/partyaffairs/api/v1/chat/setting"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *ChatHTTPClientImpl) ListChatRecord(ctx context.Context, in *ListChatRecordRequest, opts ...http.CallOption) (*ListChatRecordReply, error) {
	...
	pattern := "/partyaffairs/api/v1/chat/records"
	path := binding.EncodeURL(pattern, in, true)
