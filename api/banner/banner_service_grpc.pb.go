...
const (
	Banner_ListVisibleBanner_FullMethodName = "/partyaffairs.api.banner.Banner/ListVisibleBanner"
	Banner_ListBanner_FullMethodName        = "/partyaffairs.api.banner.Banner/ListBanner"
	Banner_CreateBanner_FullMethodName      = "/partyaffairs.api.banner.Banner/CreateBanner"
	Banner_UpdateBanner_FullMethodName      = "/partyaffairs.api.banner.Banner/UpdateBanner"
	Banner_DeleteBanner_FullMethodName      = "/partyaffairs.api.banner.Banner/DeleteBanner"
)
...
type BannerClient interface {
	// ListVisibleBanner 获取可见轮播图信息列表
	ListVisibleBanner(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListBannerReply, error)
...
func (c *bannerClient) ListVisibleBanner(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListBannerReply, error) {
	out := new(ListBannerReply)
	err := c.cc.Invoke(ctx, Banner_ListVisibleBanner_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BannerServer interface {
	// ListVisibleBanner 获取可见轮播图信息列表
	ListVisibleBanner(context.Context, *emptypb.Empty) (*ListBannerReply, error)
	// ListBanner 获取轮播图信息列表
...
func (UnimplementedBannerServer) ListVisibleBanner(context.Context, *emptypb.Empty) (*ListBannerReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListVisibleBanner not implemented")
}
...
func _Banner_ListVisibleBanner_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BannerServer).ListVisibleBanner(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Banner_ListVisibleBanner_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BannerServer).ListVisibleBanner(ctx, req.(*emptypb.Empty))
	}
...
var Banner_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "partyaffairs.api.banner.Banner",
	HandlerType: (*BannerServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ListVisibleBanner",
			Handler:    _Banner_ListVisibleBanner_Handler,
		},
		{
	...
	Metadata: "api/banner/proto/banner_service.proto",
}
