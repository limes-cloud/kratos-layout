...
const (
	Notice_GetNotice_FullMethodName         = "/partyaffairs.api.notice.Notice/GetNotice"
	Notice_ListNotice_FullMethodName        = "/partyaffairs.api.notice.Notice/ListNotice"
	Notice_ListVisibleNotice_FullMethodName = "/partyaffairs.api.notice.Notice/ListVisibleNotice"
	Notice_CreateNotice_FullMethodName      = "/partyaffairs.api.notice.Notice/CreateNotice"
	Notice_PushNotice_FullMethodName        = "/partyaffairs.api.notice.Notice/PushNotice"
	Notice_UpdateNotice_FullMethodName      = "/partyaffairs.api.notice.Notice/UpdateNotice"
	Notice_DeleteNotice_FullMethodName      = "/partyaffairs.api.notice.Notice/DeleteNotice"
)
...
type NoticeClient interface {
	...
	// ListNotice 获取通知信息列表
	ListVisibleNotice(ctx context.Context, in *ListNoticeRequest, opts ...grpc.CallOption) (*ListNoticeReply, error)
	// CreateNotice 创建通知信息
...
func (c *noticeClient) ListVisibleNotice(ctx context.Context, in *ListNoticeRequest, opts ...grpc.CallOption) (*ListNoticeReply, error) {
	out := new(ListNoticeReply)
...
func (UnimplementedNoticeServer) ListVisibleNotice(context.Context, *ListNoticeRequest) (*ListNoticeReply, error) {
...
func _Notice_ListVisibleNotice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NoticeServer).ListVisibleNotice(ctx, req.(*ListNoticeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Notice_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "partyaffairs.api.notice.Notice",
