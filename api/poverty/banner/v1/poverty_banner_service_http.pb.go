...
const OperationBannerCreateBanner = "/poverty.api.poverty.banner.v1.Banner/CreateBanner"
const OperationBannerDeleteBanner = "/poverty.api.poverty.banner.v1.Banner/DeleteBanner"
const OperationBannerListBanner = "/poverty.api.poverty.banner.v1.Banner/ListBanner"
const OperationBannerUpdateBanner = "/poverty.api.poverty.banner.v1.Banner/UpdateBanner"
...
func RegisterBannerHTTPServer(s *http.Server, srv BannerHTTPServer) {
	r := s.Route("/")
	r.GET("/poverty/client/v1/banners", _Banner_ListBanner0_HTTP_Handler(srv))
	r.GET("/poverty/api/v1/banners", _Banner_ListBanner1_HTTP_Handler(srv))
	r.POST("/poverty/api/v1/banner", _Banner_CreateBanner0_HTTP_Handler(srv))
	r.PUT("/poverty/api/v1/banner", _Banner_UpdateBanner0_HTTP_Handler(srv))
	r.DELETE("/poverty/api/v1/banner", _Banner_DeleteBanner0_HTTP_Handler(srv))
}
...
func (c *BannerHTTPClientImpl) ListBanner(ctx context.Context, in *ListBannerRequest, opts ...http.CallOption) (*ListBannerReply, error) {
	...
	pattern := "/poverty/api/v1/banners"
	path := binding.EncodeURL(pattern, in, true)
