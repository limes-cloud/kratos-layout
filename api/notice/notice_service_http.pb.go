...
const OperationNoticeCreateNotice = "/partyaffairs.api.notice.Notice/CreateNotice"
const OperationNoticeDeleteNotice = "/partyaffairs.api.notice.Notice/DeleteNotice"
const OperationNoticeGetNotice = "/partyaffairs.api.notice.Notice/GetNotice"
const OperationNoticeListNotice = "/partyaffairs.api.notice.Notice/ListNotice"
const OperationNoticeListVisibleNotice = "/partyaffairs.api.notice.Notice/ListVisibleNotice"
const OperationNoticePushNotice = "/partyaffairs.api.notice.Notice/PushNotice"
const OperationNoticeUpdateNotice = "/partyaffairs.api.notice.Notice/UpdateNotice"
...
type NoticeHTTPServer interface {
	...
	ListVisibleNotice(context.Context, *ListNoticeRequest) (*ListNoticeReply, error)
...
func RegisterNoticeHTTPServer(s *http.Server, srv NoticeHTTPServer) {
	r := s.Route("/")
	r.GET("/partyaffairs/api/v1/notice", _Notice_GetNotice0_HTTP_Handler(srv))
	r.GET("/partyaffairs/api/v1/notices", _Notice_ListNotice0_HTTP_Handler(srv))
	r.GET("/partyaffairs/api/v1/visible-notices", _Notice_ListVisibleNotice0_HTTP_Handler(srv))
...
func _Notice_ListVisibleNotice0_HTTP_Handler(srv NoticeHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		h := ctx.Middleware(func(ctx context.Context, req any) (any, error) {
			return srv.ListVisibleNotice(ctx, req.(*ListNoticeRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
type NoticeHTTPClient interface {
	...
	ListVisibleNotice(ctx context.Context, req *ListNoticeRequest, opts ...http.CallOption) (rsp *ListNoticeReply, err error)
...
func (c *NoticeHTTPClientImpl) ListVisibleNotice(ctx context.Context, in *ListNoticeRequest, opts ...http.CallOption) (*ListNoticeReply, error) {
	var out ListNoticeReply
	pattern := "/partyaffairs/api/v1/visible-notices"
	path := binding.EncodeURL(pattern, in, true)
