...
func (m *ListBannerRequest) validate(all bool) error {
	...
	if m.Order != nil {
		...
		if _, ok := _ListBannerRequest_Order_InLookup[m.GetOrder()]; !ok {
			err := ListBannerRequestValidationError{
				field:  "Order",
	...
	if m.OrderBy != nil {
		...
		if _, ok := _ListBannerRequest_OrderBy_InLookup[m.GetOrderBy()]; !ok {
			err := ListBannerRequestValidationError{
				field:  "OrderBy",
...
var _ListBannerRequest_Order_InLookup = map[string]struct{}{
	"asc":  {},
	"desc": {},
}

var _ListBannerRequest_OrderBy_InLookup = map[string]struct{}{
	"id":         {},
	"weight":     {},
	"created_at": {},
	"updated_at": {},
