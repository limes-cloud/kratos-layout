...
// Validate checks the field values on PageUserReplyData with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *PageUserReplyData) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on PageUserReplyData with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// PageUserReplyDataMultiError, or nil if none found.
func (m *PageUserReplyData) ValidateAll() error {
	return m.validate(true)
}

func (m *PageUserReplyData) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return PageUserReplyDataMultiError(errors)
	}

	return nil
}

// PageUserReplyDataMultiError is an error wrapping multiple validation errors
// returned by PageUserReplyData.ValidateAll() if the designated constraints
// aren't met.
type PageUserReplyDataMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m PageUserReplyDataMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m PageUserReplyDataMultiError) AllErrors() []error { return m }

// PageUserReplyDataValidationError is the validation error returned by
// PageUserReplyData.Validate if the designated constraints aren't met.
type PageUserReplyDataValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e PageUserReplyDataValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e PageUserReplyDataValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e PageUserReplyDataValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e PageUserReplyDataValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e PageUserReplyDataValidationError) ErrorName() string {
	return "PageUserReplyDataValidationError"
}

// Error satisfies the builtin error interface
func (e PageUserReplyDataValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sPageUserReplyData.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = PageUserReplyDataValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = PageUserReplyDataValidationError{}
