...
const OperationActivityCreateActivity = "/partyaffairs.api.activity.Activity/CreateActivity"
const OperationActivityDeleteActivity = "/partyaffairs.api.activity.Activity/DeleteActivity"
const OperationActivityGetActivity = "/partyaffairs.api.activity.Activity/GetActivity"
const OperationActivityListActivity = "/partyaffairs.api.activity.Activity/ListActivity"
const OperationActivityUpdateActivity = "/partyaffairs.api.activity.Activity/UpdateActivity"
...
func RegisterActivityHTTPServer(s *http.Server, srv ActivityHTTPServer) {
	r := s.Route("/")
	r.GET("/partyaffairs/api/v1/activity", _Activity_GetActivity0_HTTP_Handler(srv))
	r.GET("/partyaffairs/client/v1/activities", _Activity_ListActivity0_HTTP_Handler(srv))
	r.GET("/partyaffairs/api/v1/activities", _Activity_ListActivity1_HTTP_Handler(srv))
	r.POST("/partyaffairs/api/v1/activity", _Activity_CreateActivity0_HTTP_Handler(srv))
	r.PUT("/partyaffairs/api/v1/activity", _Activity_UpdateActivity0_HTTP_Handler(srv))
	r.DELETE("/partyaffairs/api/v1/activity", _Activity_DeleteActivity0_HTTP_Handler(srv))
}
...
func (c *ActivityHTTPClientImpl) CreateActivity(ctx context.Context, in *CreateActivityRequest, opts ...http.CallOption) (*CreateActivityReply, error) {
	...
	pattern := "/partyaffairs/api/v1/activity"
...
func (c *ActivityHTTPClientImpl) ListActivity(ctx context.Context, in *ListActivityRequest, opts ...http.CallOption) (*ListActivityReply, error) {
	...
	pattern := "/partyaffairs/api/v1/activities"
	path := binding.EncodeURL(pattern, in, true)
